...
public class WidgetConfigureWide extends LockBaseActivity implements OnItemClickListener{
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        final Context context = WidgetConfigureWide.this;
        ...
        if (info == null) {
            ...
            widgetInfo.type = WidgetInfo.WIDGET_TYPE_WIDE;
        ...
        WidgetProviderWide.updateAppWidget(context, appWidgetManager, mAppWidgetId, dayMatter.getUid());
