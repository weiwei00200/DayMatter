...
public class WidgetConfigureHuge extends LockBaseActivity implements OnItemClickListener{
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        final Context context = WidgetConfigureHuge.this;
        ...
        if (info == null) {
            ...
            widgetInfo.type = WidgetInfo.WIDGET_TYPE_HUGE;
        ...
        WidgetProviderHuge.updateAppWidget(context, appWidgetManager, mAppWidgetId, dayMatter.getUid());
