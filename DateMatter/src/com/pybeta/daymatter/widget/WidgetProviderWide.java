...
public class WidgetProviderWide extends AppWidgetProvider {
    ...
    private void updateWidgetView(Context context) {
        ...
        int[]  appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(context, WidgetProviderWide.class));
    ...
    public static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.daymatter_appwidget_wide);
    ...
    private static void showDayMatter(Context context, RemoteViews views, DayMatter dayMatter) {
        ...
        String dataStr = DateUtils.getMatterDateString(context, dayMatter, context.getString(R.string.matter_calendar_gregorian_date_format_1));
