...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mIncrementButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.np_numberpicker_up_normal_holo_dark));
        mIncrementButton.setOnClickListener(onClickListener);
        mIncrementButton.setOnLongClickListener(onLongClickListener);

        // decrement button
        mDecrementButton = (ImageButton) findViewById(R.id.np_decrement);
        mIncrementButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.np_numberpicker_down_normal_holo_dark));
